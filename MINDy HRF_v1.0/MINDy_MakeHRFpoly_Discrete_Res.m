function[OutStruct]=MINDy_MakeHRFpoly_Discrete_Res(X0,Pre,ParStr,NormDeriv,ParamRes,varargin)
...
OutStruct.ReMean{iXcell}=zscore(convn(Outbase(:,(1+StartDrop):(end-EndDrop)),ConvVec,'valid')')';
